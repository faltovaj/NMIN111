...
print("Test1: vyhledavani")
kontaktId = vyhledejKontakt('Novak', True)
if kontaktId != None:
    print(mujAdresar[kontaktId])
kontaktId = vyhledejKontakt('Reznicek', True)
if kontaktId != None:
    print(mujAdresar[kontaktId])
...
novyKontakt = {
    ...
    'prijmeni': 'Vackova',
    'telefon': [455566677],
    'adresa': { 'ulice': 'V Holesovickach',
                'cislo': 8,
                'mesto': 'Praha',
                'psc': 18000
              }
	}
print("Test2: pridani kontaktu")
pridejKontakt(novyKontakt)

print("Test3: odebrani kontaktu")
odeberKontakt('Novak')
print(mujAdresar)