...
class Zamestnanec:
    ...
    def __init__(self, jmeno, prijmeni, kancelar):
        self.jmeno = jmeno
        self.prijmeni = prijmeni
        self.kancelar = kancelar

    def __str__(self):
        """ Toto vypise print """
        return f'{self.cele_jmeno()}, {self.kancelar}'   
    
    def __repr__(self):
        """ Toto se dozvime, pokud se zeptame na reprezentaci """
        return f'Zamestnanec({self.jmeno}, {self.prijmeni}, {self.kancelar})'
...
class Ipnp(Zamestnanec):
    """ Trida Ipnp pro zamestnance na IPNP, """
    budova = 'Troja'
    patro = [8, 9]
